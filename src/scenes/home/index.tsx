...
const Home = ({ setSelectedPage }: Props) => {
  ...
  return (
    <section id="home" className="gap-16 bg-gray-20 py-10 md:h-full md:pb-0">
      <motion.div className="mx-auto w-5/6 items-center justify-center md:flex md:h-5/6">
        <div className="z-10 mt-32 md:basis-3/5">
          ...
          >
            ...
            <AnchorLink
              className="text-sm font-bold text-purple-500 underline hover:text-secondary-500"
      ...
      {/* for Desktop- sponsors company */}
      {isAboveMediumScreens && (
        <div className="h-[150px] w-full bg-primary-100 py-10 px-8">
